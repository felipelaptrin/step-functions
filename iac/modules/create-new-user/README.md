...
| <a name="input_lambda_architecture"></a> [lambda\_architecture](#input\_lambda\_architecture) | Instruction set architecture for your Lambda function. Valid values are 'x86\_64' 'arm64'. Since we are also deploying the image via local deployemnt this should correspond to your computer architecture | `string` | `"arm64"` | no |
